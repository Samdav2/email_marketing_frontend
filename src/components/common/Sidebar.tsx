      ...
      >
        ...
        <div className="p-6 border-b border-white/10 flex items-center justify-between">
          <Link href="/dashboard" className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-blue-600 to-cyan-400 flex items-center justify-center glow-blue">
              <Mail className="w-5 h-5 text-white" />
            </div>
            <div>
              <span className="font-extrabold text-lg text-white tracking-tight">LeadFlow</span>
              <span className="block text-[10px] font-semibold text-cyan-400 uppercase">
                UK Scrape Hub v1.1
              </span>
            </div>
          </Link>
        ...
        <div className="flex-1 overflow-y-auto px-4 py-6 space-y-1.5">
          <p className="px-3 text-[11px] font-bold uppercase tracking-wider text-gray-500 mb-2">
            Command Center
          </p>
                ...
                <div className="flex items-center gap-3">
                  <Icon
                    className={`w-5 h-5 transition-colors ${
                      isActive ? 'text-blue-400' : 'text-gray-400 group-hover:text-cyan-400'
                    }`}
                  />
                  <span>{item.name}</span>
                </div>
        ...
        <div className="p-4 mx-4 mb-4 rounded-xl bg-slate-900/60 border border-white/5 space-y-2">
          ...
          <p className="text-[11px] text-gray-500">FastAPI backend linked & CDX UK discovery ready.</p>
        </div>
